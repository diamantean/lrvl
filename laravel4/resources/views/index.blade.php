...
<body>
    <center>
        <h1 style="font-family: poppins; padding-top: 20px;">Perpustakaan Digital SMKN 4 Bandung</h1>
    </center>
    <br />
    <br />
    <div class="container">
        ...
        <br>
        <br>
        <table id="crudapp" class="table table-striped table-bordered" style="width:100%">
            <thead>
                <tr>
                    <th>Judul Buku</th>
                    <th>Tahun Terbit</th>
